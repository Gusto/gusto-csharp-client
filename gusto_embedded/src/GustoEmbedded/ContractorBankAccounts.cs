...
namespace GustoEmbedded
{
    ...
    public interface IContractorBankAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<PostV1ContractorsContractorUuidBankAccountsResponse> CreateAsync(string contractorUuid, PostV1ContractorsContractorUuidBankAccountsRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1ContractorsContractorUuidBankAccountsResponse> ListAsync(string contractorUuid, VersionHeader? xGustoAPIVersion = null);
    }

    public class ContractorBankAccounts: IContractorBankAccounts
    {
        ...
        public ContractorBankAccounts(ISpeakeasyHttpClient client, Func<GustoEmbedded.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<PostV1ContractorsContractorUuidBankAccountsResponse> CreateAsync(string contractorUuid, PostV1ContractorsContractorUuidBankAccountsRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
        ...
        public async Task<GetV1ContractorsContractorUuidBankAccountsResponse> ListAsync(string contractorUuid, VersionHeader? xGustoAPIVersion = null)
        {
