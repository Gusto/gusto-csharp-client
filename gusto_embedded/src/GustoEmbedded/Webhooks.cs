...
namespace GustoEmbedded
{
    ...
    public interface IWebhooks
    {
        ...
        /// </remarks>
        /// </summary>
        Task<PutV1WebhookSubscriptionUuidResponse> UpdateAsync(PutV1WebhookSubscriptionUuidSecurity security, string webhookSubscriptionUuid, PutV1WebhookSubscriptionUuidRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
    ...
    public class Webhooks: IWebhooks
    {
        ...
        public async Task<PutV1WebhookSubscriptionUuidResponse> UpdateAsync(PutV1WebhookSubscriptionUuidSecurity security, string webhookSubscriptionUuid, PutV1WebhookSubscriptionUuidRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
