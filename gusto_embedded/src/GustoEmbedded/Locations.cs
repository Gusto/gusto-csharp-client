...
namespace GustoEmbedded
{
    ...
    public interface ILocations
    {
        ...
        /// </remarks>
        /// </summary>
        Task<PostV1CompaniesCompanyIdLocationsResponse> PostV1CompaniesCompanyIdLocationsAsync(string companyId, PostV1CompaniesCompanyIdLocationsRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1LocationsLocationIdResponse> GetV1LocationsLocationIdAsync(string locationId, VersionHeader? xGustoAPIVersion = null);
        ...
        /// </remarks>
        /// </summary>
        Task<PutV1LocationsLocationIdResponse> PutV1LocationsLocationIdAsync(string locationId, PutV1LocationsLocationIdRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1LocationsLocationUuidMinimumWagesResponse> GetV1LocationsLocationUuidMinimumWagesAsync(string locationUuid, string? effectiveDate = null, VersionHeader? xGustoAPIVersion = null);
    }
    ...
    public class Locations: ILocations
    {
        ...
        public async Task<PostV1CompaniesCompanyIdLocationsResponse> PostV1CompaniesCompanyIdLocationsAsync(string companyId, PostV1CompaniesCompanyIdLocationsRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
        ...
        public async Task<GetV1LocationsLocationIdResponse> GetV1LocationsLocationIdAsync(string locationId, VersionHeader? xGustoAPIVersion = null)
        {
        ...
        public async Task<PutV1LocationsLocationIdResponse> PutV1LocationsLocationIdAsync(string locationId, PutV1LocationsLocationIdRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
        ...
        public async Task<GetV1LocationsLocationUuidMinimumWagesResponse> GetV1LocationsLocationUuidMinimumWagesAsync(string locationUuid, string? effectiveDate = null, VersionHeader? xGustoAPIVersion = null)
        {
