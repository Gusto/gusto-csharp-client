...
namespace GustoEmbedded
{
    ...
    public interface IEmployeePaymentMethods
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1EmployeesEmployeeIdBankAccountsResponse> GetBankAccountsAsync(string employeeId, long? page = null, long? per = null, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFour0401);
    }
    ...
    public class EmployeePaymentMethods: IEmployeePaymentMethods
    {
        ...
        public async Task<GetV1EmployeesEmployeeIdBankAccountsResponse> GetBankAccountsAsync(string employeeId, long? page = null, long? per = null, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFour0401)
        {
