...
namespace GustoEmbedded
{
    ...
    public interface IBankAccounts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1CompaniesCompanyIdBankAccountsResponse> ListAsync(string companyId, VersionHeader? xGustoAPIVersion = null);
        ...
        /// </remarks>
        /// </summary>
        Task<PostV1PlaidProcessorTokenResponse> CreateFromProcessorTokenAsync(PostV1PlaidProcessorTokenRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
    }
    ...
    public class BankAccounts: IBankAccounts
    {
        ...
        public async Task<GetV1CompaniesCompanyIdBankAccountsResponse> ListAsync(string companyId, VersionHeader? xGustoAPIVersion = null)
        {
        ...
        public async Task<PostV1PlaidProcessorTokenResponse> CreateFromProcessorTokenAsync(PostV1PlaidProcessorTokenRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
