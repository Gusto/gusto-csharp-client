...
namespace GustoEmbedded
{
    ...
    public interface INotifications
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetNotificationsNotificationUuidResponse> GetDetailsAsync(string notificationUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01);
    }
    ...
    public class Notifications: INotifications
    {
        ...
        public async Task<GetNotificationsNotificationUuidResponse> GetDetailsAsync(string notificationUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "get-notifications-notification_uuid", new List<string> {  }, _securitySource);
