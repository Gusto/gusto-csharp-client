...
namespace GustoEmbedded
{
    ...
    public interface IHistoricalEmployees
    {
        ...
        /// </remarks>
        /// </summary>
        Task<PutV1HistoricalEmployeesResponse> UpdateAsync(string companyUuid, string historicalEmployeeUuid, PutV1HistoricalEmployeesRequestBody requestBody, VersionHeader? xGustoAPIVersion = null);
    }
    ...
    public class HistoricalEmployees: IHistoricalEmployees
    {
        ...
        public async Task<PutV1HistoricalEmployeesResponse> UpdateAsync(string companyUuid, string historicalEmployeeUuid, PutV1HistoricalEmployeesRequestBody requestBody, VersionHeader? xGustoAPIVersion = null)
        {
