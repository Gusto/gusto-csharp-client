...
namespace GustoEmbedded
{
    ...
    public interface IRecoveryCases
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetRecoveryCasesResponse> GetAsync(string companyUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01);
        ...
        /// </remarks>
        /// </summary>
        Task<RedebitRecoveryCaseResponse> RedebitAsync(string recoveryCaseUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01);
    }
    ...
    public class RecoveryCases: IRecoveryCases
    {
        ...
        public async Task<GetRecoveryCasesResponse> GetAsync(string companyUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "get-recovery-cases", new List<string> {  }, _securitySource);
        ...
        public async Task<RedebitRecoveryCaseResponse> RedebitAsync(string recoveryCaseUuid, VersionHeader? xGustoAPIVersion = GustoEmbedded.Models.Components.VersionHeader.TwoThousandAndTwentyFourMinus04Minus01)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "redebit-recovery-case", new List<string> {  }, _securitySource);
