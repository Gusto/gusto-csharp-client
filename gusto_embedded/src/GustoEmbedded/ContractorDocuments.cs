...
namespace GustoEmbedded
{
    ...
    public interface IContractorDocuments
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetV1ContractorDocumentsResponse> ListAsync(string contractorUuid, VersionHeader? xGustoAPIVersion = null);
    ...
    public class ContractorDocuments: IContractorDocuments
    {
        ...
        public async Task<GetV1ContractorDocumentsResponse> ListAsync(string contractorUuid, VersionHeader? xGustoAPIVersion = null)
        {
