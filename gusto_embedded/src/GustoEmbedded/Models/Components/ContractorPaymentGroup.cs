...
namespace GustoEmbedded.Models.Components
{
    ...
    public class ContractorPaymentGroup
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public ContractorPaymentGroupStatus? Status { get; set; }
        ...
        [JsonProperty("totals")]
        public ContractorPaymentGroupTotals? Totals { get; set; }

        [JsonProperty("contractor_payments")]
        public List<ContractorPaymentForGroup>? ContractorPayments { get; set; }
    }
}