...
namespace GustoEmbedded.Models.Components
{
    ...
    public class TaxRequirementMetadata
    {
        ...
        /// </summary>
        [JsonProperty("type")]
        public TaxRequirementMetadataType Type { get; set; } = default!;

        /// <summary>
        /// [for `select` or `radio`] An array of objects describing the possible values.
        /// </summary>
        [JsonProperty("options")]
        public List<TaxRequirementMetadataOptions>? Options { get; set; }
        ...
        public string? RiskClassDescription { get; set; }
        ...
        /// <summary>
        /// [for `account_number`] A pattern describing the format of the account number<br/>
        /// 
        /// <remarks>
        /// <br/>
        /// The mask is a sequence of characters representing the requirements of the actual account number. Each character in the mask represents a single character in the account number as follows:<br/>
        /// - `#`: a digit (`\d`)<br/>
        /// - `@`: a upper or lower case letter (`[a-zA-Z]`)<br/>
        /// - `^`: an uppercase letter (`[A-Z]`)<br/>
        /// - `%`: a digit or uppercase letter (`[0-9A-Z]`)<br/>
        /// - any other character represents the literal character<br/>
        /// <br/>
        /// Examples:<br/>
        /// - mask: `WHT-######` represents `WHT-` followed by 5 digits, e.g. `WHT-33421`<br/>
        /// - mask: `%####-^^` supports values of `75544-AB` and `Z7654-HK`<br/>
        /// 
        /// </remarks>
        /// </summary>
        [JsonProperty("mask")]
