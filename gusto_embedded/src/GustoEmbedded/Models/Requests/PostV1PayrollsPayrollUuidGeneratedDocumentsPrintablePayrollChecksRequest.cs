...
namespace GustoEmbedded.Models.Requests
{
    ...
    public class PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequest
    {
        ...
        public string PayrollUuid { get; set; } = default!;

        [SpeakeasyMetadata("request:mediaType=application/json")]
        public PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequestBody RequestBody { get; set; } = default!;
