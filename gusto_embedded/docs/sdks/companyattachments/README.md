...
* [GetV1CompaniesAttachmentUrl](#getv1companiesattachmenturl) - Get a temporary url to download the Company Attachment file

## GetV1CompaniesAttachmentUrl
...
var res = await sdk.CompanyAttachments.GetV1CompaniesAttachmentUrlAsync(
    companyId: "<id>",
